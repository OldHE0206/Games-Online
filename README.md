...
Automated Management: Automatically identifies, categorizes, and manages Maya scene files.
自动化管理：自动识别、分类和管理Maya场景文件

Intelligent Naming: Supports automatic renaming of model and texture files.
智能命名：支持模型和贴图文件的自动重命名

Material Management: Automatically creates material networks and connects textures.
材质管理：自动创建材质网络并连接贴图

Format Conversion: Supports mutual conversion between OBJ and FBX formats.
格式转换：支持OBJ与FBX格式的相互转换

Project Management: Complete supplier-reviewer workflow management.
项目管理：完整的供应商-审核人员工作流程管理
